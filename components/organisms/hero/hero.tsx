...
export const Hero = () => {
  ...
  return (
    <section className="food-hero flex flex-col lg:flex-row items-center justify-between bg-primary w-full h-auto lg:h-[500px] xl:h-[580px] 2xl:h-[628px] px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-[220px] py-8 lg:py-0 overflow-hidden">
      {/* Left Section */}
      <div className="food-hero-left flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-7 2xl:gap-8 w-full lg:w-[600px] xl:w-[750px] 2xl:w-[856px]">
        {/* Headline */}
        ...
        {/* Search Bar Card */}
        <div
          className="food-search-card bg-white w-full lg:w-[600px] xl:w-[750px] 2xl:w-[856px] h-auto 2xl:h-[194.44px] rounded-xl 2xl:rounded-2xl p-4 md:p-5 2xl:p-6 flex flex-col gap-3 2xl:gap-0"
          style={{
            boxShadow:
        ...
        >
          ...
          <div className="food-search-section w-full 2xl:w-[808px] h-auto 2xl:h-[108px] flex flex-col sm:flex-row items-stretch sm:items-center gap-2 md:gap-3 2xl:gap-4">
            {/* Search Input */}
            <div className="food-search-input-wrapper flex items-center bg-input-bg w-full sm:flex-1 md:w-auto lg:w-[450px] xl:w-[520px] 2xl:w-[595px] h-12 md:h-[54px] lg:h-[58px] 2xl:h-[60px] rounded-lg 2xl:rounded-xl px-3 md:px-4 gap-2 md:gap-3">
              <IconWrapper
                iconName="search-1"
                size={16}
            ...
            <Button
              ...
              style={{
                ...
                boxShadow: isSearching
                  ? "none"
                  : "0px 20px 40px 0px rgba(255, 122, 122, 0.29), 0px 5px 10px 0px rgba(255, 122, 122, 0.26)",
              }}
      ...
      <div className="food-hero-right hidden lg:block relative w-full max-w-[350px] sm:max-w-[400px] md:max-w-[450px] lg:w-[480px] xl:w-[550px] 2xl:w-[604px] h-[280px] sm:h-80 md:h-[380px] lg:h-[420px] xl:h-[470px] 2xl:h-[505px] mt-8 lg:mt-0 rotate-0 self-end z-0 lg:-mb-10 2xl:-mb-14">
        {/* Overlay Layer */}
        <div className="food-hero-overlay absolute w-[300px] sm:w-[330px] md:w-[380px] lg:w-[400px] xl:w-[450px] 2xl:w-[497.14px] h-[300px] sm:h-[330px] md:h-[380px] lg:h-[400px] xl:h-[450px] 2xl:h-[497.14px] 2xl:top-[-3.21px] 2xl:left-[102.51px] top-0 left-5 md:left-[30px] lg:left-[60px] -rotate-180">
          {/* Rectangle */}
          <div
        ...
        {/* Actual Hero Image */}
        <div className="food-hero-image absolute w-[300px] sm:w-[330px] md:w-[380px] lg:w-[400px] xl:w-[450px] 2xl:w-[497.14px] h-[300px] sm:h-[330px] md:h-[380px] lg:h-[400px] xl:h-[450px] 2xl:h-[497.14px] 2xl:top-[-3.21px] 2xl:left-[102.51px] top-0 left-5 md:left-[30px] lg:left-[60px] z-10">
          <Image
        ...
        <div className="food-hero-shadow absolute w-full md:w-[500px] lg:w-[550px] 2xl:w-[619px] h-full md:h-[500px] lg:h-[550px] 2xl:h-[612px] 2xl:left-[-19px] -left-2.5 md:left-[-15px] top-0 -rotate-180">
          {/* Ellipse 1 - Inner glow */}
          <div
            className="food-hero-ellipse-1 absolute w-[350px] sm:w-[380px] md:w-[430px] lg:w-[480px] 2xl:w-[539px] h-[350px] sm:h-[380px] md:h-[430px] lg:h-[480px] 2xl:h-[540px] top-[11px] left-5 md:left-[35px] lg:left-[50px] 2xl:left-[61px] rounded-full opacity-80 -rotate-180"
            style={{
              background:
                "radial-gradient(circle, #454444 0%, rgba(196, 196, 196, 0) 100%)",
          ...
          <div
            className="food-hero-ellipse-2 absolute w-full md:w-[500px] lg:w-[550px] 2xl:w-[611px] h-full md:h-[500px] lg:h-[550px] 2xl:h-[612px] top-[11px] -left-2.5 md:left-[-15px] 2xl:left-[-19px] rounded-full opacity-70 -rotate-180"
            style={{
