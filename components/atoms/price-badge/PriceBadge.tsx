...
export const PriceBadge = ({ price, className = "" }: PriceBadgeProps) => {
  return (
    <div
      className={`food-price-badge flex items-center justify-center gap-2 md:gap-2.5 bg-selected w-[90px] md:w-[100px] 2xl:w-[114px] h-[36px] md:h-[40px] 2xl:h-[42px] rounded-md 2xl:rounded-lg ${className}`}
